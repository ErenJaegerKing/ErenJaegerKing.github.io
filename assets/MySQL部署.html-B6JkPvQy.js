import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as l,o as i}from"./app-5IhvQ8d1.js";const p={};function e(c,s){return i(),a("div",null,s[0]||(s[0]=[l(`<h3 id="mysql部署" tabindex="-1"><a class="header-anchor" href="#mysql部署"><span>MySQL部署</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>MySQL数据库</span></span>
